...
or any other MT(K)3333-based GPS receiver, connected through i2c (slave address 0x10). The GPS receiver can be used as a source of authoritative time (like NTP) and speed of movement.
