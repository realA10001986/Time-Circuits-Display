...
- the latest matching sound-pack ("sound-pack-xxxx.zip")
- some additional bonus sound files ("alt_sound")

## Firmware Installation

If a previous version of the TCD firmware is installed on your device, you can update easily using the pre-compiled binary. Enter the [Config Portal](../README.md#the-config-portal), click on "Update" and select the pre-compiled binary file ("xxx.bin") provided in the Release package.
...
_Note that installing the sound-pack requires an SD card._
...
Next, head to the [Config Portal](../README.md#the-config-portal), click on *Update*, select the "TCDA.bin" file in the bottom file selector and click on *Upload*.
