...
This repository holds the most current firmware for CircuitSetup's wonderful [Time Circuits Display](https://circuitsetup.us/product/complete-time-circuits-display-kit/) ("TCD") kit for reproducing an essential and iconic part of the Delorean Time Machine.

The parts are available [here](https://circuitsetup.us/product/complete-time-circuits-display-kit/).
