...
static const char* myHead = "<script>window.onload=function(){if(document.getElementById('ebnew')||document.getElementById('uploadbin')){d=document.createElement('div');d.classList.add('tpm');b=document.getElementsByTagName('H3');a=document.getElementsByTagName('H1');a[0].parentNode.style.position='relative';d.innerHTML='<div class=\"tpm2\"><img src=\"data:image/png;base64,\" class=\"tpm3\"></div><H1 class=\"tpmh1\">'+a[0].innerHTML+'</H1>'+'<H3 class=\"tpmh3\">'+b[0].innerHTML+'</div>';b[0].remove();a[0].replaceWith(d);}if(a=document.getElementById('uploadbin')){a.parentElement.onsubmit=function(){a=document.getElementById('uploadbin');if(a){a.disabled=true;a.innerHTML='Please wait';}}}}</script><style type='text/css'>body{font-family:-apple-system,BlinkMacSystemFont,system-ui,'Segoe UI',Roboto,'Helvetica Neue',Verdana,Helvetica}H1,H2{margin-top:0px;margin-bottom:0px;text-align:center;}H3{margin-top:0px;margin-bottom:5px;text-align:center;}div.msg{border:1px solid #ccc;border-left-width:15px;border-radius:20px;background:linear-gradient(320deg,rgb(255,255,255) 0%,rgb(235,234,233) 100%);}button{transition-delay:250ms;margin-top:10px;margin-bottom:10px;color:#fff;background-color:#225a98;font-variant-caps:all-small-caps;}button.DD{color:#000;border:4px ridge #999;border-radius:2px;background:#e0c942;background-image:url('data:image/png;base64,');background-repeat:no-repeat;background-origin:content-box;background-size:contain;}br{display:block;font-size:1px;content:''}input[type='checkbox']{display:inline-block;margin-top:10px}input{border:thin inset}small{display:none}em > small{display:inline}form{margin-block-end:0;}.tpm{border:1px solid black;border-radius:5px;padding: 0 0 0 0px;overflow:hidden;}.tpm2{position:absolute;top:-0.7em;z-index:130;left:0.7em;}.tpm3{width:4em;height:4em;}.tpmh1{font-variant-caps:all-small-caps;margin-left:2em;}.tpmh3{background:#000;font-size:0.6em;color:#ffa;padding-left:6em;margin-left:0.5em;margin-right:0.5em;border-radius:5px}</style>";
